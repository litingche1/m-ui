<template>
    <main>
        ...
        <section v-if="pagination && !loading" class="pagination" :style="{ justifyContent }">
            <el-pagination
...
<script lang="ts" setup>
    ...
    let emits = defineEmits(['confirm','cancel','update:editRowIdx','size-change', 'current-change'])
