              ...
              return openBlock(), createElementBlock(Fragment, {
                ...
                !item.children || item.children.length === 0 ? (openBlock(), createBlock(_component_el_form_item, {
                  ...
                  default: withCtx(() => [
                    ...
                    }), null, 16, ["modelValue", "onUpdate:modelValue", "placeholder"])) : createCommentVNode("", true),
                  ...
                  _: 2
                }, 1032, ["label", "prop"])) : (openBlock(), createBlock(_component_el_form_item, {
                  key: 1,
                  label: item.label,
                  prop: item.prop
                }, {
                    ...
                    (openBlock(), createBlock(resolveDynamicComponent(`el-${item.type}`), mergeProps({
                      ...
                      default: withCtx(() => [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(item.children, (child, idx) => {
                          return openBlock(), createBlock(resolveDynamicComponent(`el-${child.type}`), mergeProps({ key: idx }, child.attrs, {
                            label: child.label,
                            value: child.value
                          }), null, 16, ["label", "value"]);
                        }), 128))
