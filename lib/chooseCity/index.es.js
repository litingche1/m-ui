import { defineComponent, ref, reactive, watch, resolveComponent, openBlock, createElementBlock, createVNode, unref, isRef, withCtx, Fragment, renderList, createBlock } from "vue";
var AreaData = [
  {
    code: "11",
    name: "\u5317\u4EAC\u5E02",
...
const _sfc_main = defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    watch(() => city.value, (val) => {
      if (val) {
        areaOptions.value = cityOptions.value.find((item) => item.code === val).children;
      }
      area.value = "";
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("main", null, [
        createVNode(_component_el_select, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(cityList), (item) => {
        ...
        createVNode(_component_el_select, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(areaOptions), (item) => {
              return openBlock(), createBlock(_component_el_option, {
                key: item.code,
                label: item.name,
                value: item.code
...
var chooseCity = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1640d14f"]]);
var index = {
  install(app) {
