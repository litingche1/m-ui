...
import { defineComponent, resolveComponent, openBlock, createElementBlock, createVNode, mergeProps, withCtx, Fragment, renderList, createBlock, resolveDynamicComponent, unref, createElementVNode, toDisplayString, createCommentVNode, createStaticVNode, useAttrs, isVNode } from "vue";
const toLine = (value) => {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("main", null, [
        createVNode(_component_el_menu, mergeProps({ class: "el-menu-vertical-demo" }, _ctx.$attrs, {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.data, (item) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                !item.children || item.children.length === 0 ? (openBlock(), createBlock(_component_el_menu_item, {
                  ...
                  default: withCtx(() => [
                    (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(item.icon)}`))),
                    createElementVNode("span", null, toDisplayString(item.name), 1)
                  ]),
                  _: 2
                }, 1032, ["index"])) : createCommentVNode("", true),
                item.children && item.children.length > 0 ? (openBlock(), createBlock(_component_el_sub_menu, {
                  key: 1,
                  index: "1-4"
                }, {
                  title: withCtx(() => [
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(item.children, (child) => {
                      return openBlock(), createBlock(_component_el_menu_item, {
                        ...
                        default: withCtx(() => [
                          (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(child.icon)}`))),
                          createElementVNode("span", null, toDisplayString(child.name), 1)
                        ]),
                        _: 2
                      }, 1032, ["index"]);
                    }), 256))
...
var menu$1 = /* @__PURE__ */ _export_sfc$1(_sfc_main$4r, [["__scopeId", "data-v-62b8faaf"]]);
