import { defineComponent, ref, onMounted, watch, openBlock, createElementBlock, Fragment as Fragment$1, createTextVNode, createElementVNode } from "vue";
...
var n$1, l$2, u$2, t$1, o$2, r$2, f$1, e$2 = {}, c$2 = [], s$1 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function a$2(n2, l2) {
  for (var u2 in l2)
    n2[u2] = l2[u2];
  return n2;
...
function y$1(n2, i, t2, o2, r2) {
  var f2 = { type: n2, props: i, key: t2, ref: o2, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: r2 == null ? ++u$2 : r2 };
...
function m$2(n2) {
  (!n2.__d && (n2.__d = true) && t$1.push(n2) && !g$2.__r++ || r$2 !== l$2.debounceRendering) && ((r$2 = l$2.debounceRendering) || o$2)(g$2);
}
function g$2() {
  for (var n2; g$2.__r = t$1.length; )
    n2 = t$1.sort(function(n3, l2) {
      ...
      n3.__d && (o2 = (t2 = (l2 = n3).__v).__e, (r2 = l2.__P) && (u2 = [], (i = a$2({}, t2)).__v = t2.__v + 1, j$3(r2, t2, i, l2.__n, r2.ownerSVGElement !== void 0, t2.__h != null ? [o2] : null, u2, o2 == null ? k$2(t2) : o2, t2.__h), z$1(u2, t2), t2.__e != o2 && b$2(t2)));
    });
}
function w$2(n2, l2, u2, i, t2, o2, r2, f2, s2, a2) {
...
function x$1(n2, l2, u2) {
  for (var i, t2 = n2.__k, o2 = 0; t2 && o2 < t2.length; o2++)
    (i = t2[o2]) && (i.__ = n2, l2 = typeof i.type == "function" ? x$1(i, l2, u2) : P$2(u2, i, i, t2, i.__e, l2));
  return l2;
}
  ...
  n:
    if (l2 === "style")
      if (typeof u2 == "string")
        ...
        if (u2)
          for (l2 in u2)
            i && u2[l2] === i[l2] || $$2(n2.style, l2, u2[l2]);
      }
    else if (l2[0] === "o" && l2[1] === "n")
      o2 = l2 !== (l2 = l2.replace(/Capture$/, "")), l2 = l2.toLowerCase() in n2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + o2] = u2, u2 ? i || n2.addEventListener(l2, o2 ? T$2 : I$2, o2) : n2.removeEventListener(l2, o2 ? T$2 : I$2, o2);
  ...
  try {
    n:
      if (typeof $2 == "function") {
        if (m2 = u2.props, g2 = (s2 = $2.contextType) && t2[s2.__c], x2 = s2 ? g2 ? g2.props.value : s2.__ : t2, i.__c ? b2 = (h2 = u2.__c = i.__c).__ = h2.__E : ("prototype" in $2 && $2.prototype.render ? u2.__c = h2 = new $2(m2, x2) : (u2.__c = h2 = new _$1(m2, x2), h2.constructor = $2, h2.render = O$2), g2 && g2.sub(h2), h2.props = m2, h2.state || (h2.state = {}), h2.context = x2, h2.__n = t2, v2 = h2.__d = true, h2.__h = []), h2.__s == null && (h2.__s = h2.state), $2.getDerivedStateFromProps != null && (h2.__s == h2.state && (h2.__s = a$2({}, h2.__s)), a$2(h2.__s, $2.getDerivedStateFromProps(m2, h2.__s))), y2 = h2.props, p2 = h2.state, v2)
        ...
        h2.state = h2.__s, h2.getChildContext != null && (t2 = a$2(a$2({}, t2), h2.getChildContext())), v2 || h2.getSnapshotBeforeUpdate == null || (k2 = h2.getSnapshotBeforeUpdate(y2, p2)), C2 = s2 != null && s2.type === d$1 && s2.key == null ? s2.props.children : s2, w$2(n2, Array.isArray(C2) ? C2 : [C2], u2, i, t2, o2, r2, f2, e2, c2), h2.base = u2.__e, u2.__h = null, h2.__h.length && f2.push(h2), b2 && (h2.__E = h2.__ = null), h2.__e = false;
      } else
...
function L$2(l2, u2, i, t2, o2, r2, f2, c2) {
  ...
  if (d2 === null)
    ...
    if (C$2(l2, p2, y2, o2, c2), v2)
      u2.__k = [];
    else if (_2 = u2.props.children, w$2(l2, Array.isArray(_2) ? _2 : [_2], u2, i, t2, o2 && d2 !== "foreignObject", r2, f2, r2 ? r2[0] : i.__k && k$2(i, 0), c2), r2 != null)
      for (_2 = r2.length; _2--; )
...
function N$1(n2, u2, i) {
  ...
  i || n2.__e == null || h$1(n2.__e), n2.__e = n2.__d = void 0;
}
...
function S$2(u2, i, t2) {
  var o2, r2, f2;
  l$2.__ && l$2.__(u2, i), r2 = (o2 = typeof t2 == "function") ? null : t2 && t2.__k || i.__k, f2 = [], j$3(i, u2 = (!o2 && t2 || i).__k = v$2(d$1, null, [u2]), r2 || e$2, e$2, i.ownerSVGElement !== void 0, !o2 && t2 ? [t2] : r2 ? null : i.firstChild ? n$1.call(i.childNodes) : null, f2, !o2 && t2 ? t2 : r2 ? r2.__e : i.firstChild, o2), z$1(f2, u2);
}
function D$1(n2, l2) {
...
n$1 = c$2.slice, l$2 = { __e: function(n2, l2, u2, i) {
  ...
  throw n2;
} }, u$2 = 0, _$1.prototype.setState = function(n2, l2) {
  var u2;
  u2 = this.__s != null && this.__s !== this.state ? this.__s : this.__s = a$2({}, this.state), typeof n2 == "function" && (n2 = n2(a$2({}, u2), this.props)), n2 && a$2(u2, n2), n2 != null && this.__v && (l2 && this.__h.push(l2), m$2(this));
}, _$1.prototype.forceUpdate = function(n2) {
  this.__v && (this.__e = true, n2 && this.__h.push(n2), m$2(this));
}, _$1.prototype.render = d$1, t$1 = [], o$2 = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, g$2.__r = 0, f$1 = 0;
var n, l$1, u$1, t, o$1, r$1, e$1 = {}, c$1 = [], s = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function a$1(n2, l2) {
  for (var u2 in l2)
    n2[u2] = l2[u2];
  return n2;
...
}, _.prototype.render = d, t = [], o$1 = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, g$1.__r = 0;
...
function flushSync$1(runBeforeFlush) {
  runBeforeFlush();
  var oldDebounceRendering = l$2.debounceRendering;
  var callbackQ = [];
  function execCallbackSync(callback) {
    callbackQ.push(callback);
  }
  l$2.debounceRendering = execCallbackSync;
  S$2(v$2(FakeComponent, {}), document.createElement("div"));
...
const _hoisted_1 = /* @__PURE__ */ createTextVNode(" 321321 ");
const _hoisted_2 = /* @__PURE__ */ createElementVNode("main", { id: "calendar" }, null, -1);
